...
(window.WebComponents = window.WebComponents || {}),
  (function(e) {
    ...
    (t.shadow = t.shadow || t.shadowdom || t.polyfill),
      (t.shadow = 'native' === t.shadow ? !1 : t.shadow || !HTMLElement.prototype.createShadowRoot),
      t.register &&
        ((window.CustomElements = window.CustomElements || { flags: {} }),
        (window.CustomElements.flags.register = t.register)),
      (e.flags = t);
  })(WebComponents),
  WebComponents.flags.shadow &&
    ...
    (function(e) {
      ...
      function f(e) {
        return k && d(e)
          ? new Function('return this.__impl4cf1e782hg__.' + e + '.apply(this.__impl4cf1e782hg__, arguments)')
          : function() {
          ...
          if ('polymerBlackList_' !== s && !(s in n || (t.polymerBlackList_ && t.polymerBlackList_[s]))) {
            ...
            if ('function' != typeof d.value) {
              ...
              (c = w ? e.getEventHandlerGetter(s) : p(s)),
                (d.writable || d.set || V) && (l = w ? e.getEventHandlerSetter(s) : h(s));
      ...
      var q = /Firefox/.test(navigator.userAgent),
        B = { get: function() {}, set: function(e) {}, configurable: !0, enumerable: !0 },
        V = (function() {
      ...
      (n.prototype = {
        ...
        calcSplices: function(e, n, s, c, l, u) {
          ...
          if (
            ...
            s == e.length && u == c.length && (p = this.sharedSuffix(e, c, h - d)),
            (n += d),
            (l += d),
            (s -= p),
            (u -= p),
          ...
          for (
            var m = this.spliceOperationsFromEditDistances(this.calcEditDistances(e, n, s, c, l, u)),
              f = void 0,
              w = [],
              v = n,
              g = l,
    ...
    (function(e) {
            ...
            for (var l = 0; l < c.length; l++) {
              ...
              if (
                ...
                !(
                  ...
                  ('attributes' === n &&
                    d.attributeFilter &&
                    (null !== o.namespace || -1 === d.attributeFilter.indexOf(o.name))) ||
                ...
                var p = u.observer;
                (i[p.uid_] = p),
                  (('attributes' === n && d.attributeOldValue) || ('characterData' === n && d.characterDataOldValue)) &&
                    (a[p.uid_] = o.oldValue);
              }
            }
        }
      ...
      function s(e) {
        if (
          ...
          (this.attributes =
            'attributes' in e || !('attributeOldValue' in e || 'attributeFilter' in e) ? !!e.attributes : !0),
    ...
    (function(e) {
      ...
      function _(e, t, n) {
        ...
        if (((o.prototype = Object.create(t.prototype)), n && W(o.prototype, n), r))
          try {
            F(r, o, new r('temp'));
          } catch (i) {
      ...
      var ce = _('UIEvent', y),
        ...
        de = W({ initMouseEvent: S('initMouseEvent', 14) }, ue),
        pe = W({ initFocusEvent: S('initFocusEvent', 5) }, ue),
      ...
      if (!we) {
        ...
        ve('Event', { bubbles: !1, cancelable: !1 }),
          ve('CustomEvent', { detail: null }, 'Event'),
          ve('UIEvent', { view: null, detail: 0 }, 'Event'),
          ve(
            'MouseEvent',
            {
              screenX: 0,
          ...
          ve('FocusEvent', { relatedTarget: null }, 'UIEvent');
      }
      ...
      (e.elementFromPoint = x),
        ...
        (e.wrappers.FocusEvent = fe),
        (e.wrappers.MouseEvent = he),
        (e.wrappers.UIEvent = ce);
    })(window.ShadowDOMPolyfill),
    (function(e) {
      'use strict';
      function t(e, t) {
    ...
    (function(e) {
        ...
        if (e.invalidateShadowRenderer()) {
          for (var t = e.firstChild; t; ) {
            ...
            var n = t.nextSibling,
              r = P(t),
              o = r.parentNode;
            o && $.call(o, r), (t.previousSibling_ = t.nextSibling_ = t.parentNode_ = null), (t = n);
          }
          e.firstChild_ = e.lastChild_ = null;
        } else for (var n, i = P(e), a = i.firstChild; a; ) (n = a.nextSibling), $.call(i, a), (a = n);
      }
      function g(e) {
        var t = e.parentNode;
      ...
      var S = e.wrappers.EventTarget,
        ...
        Y = V.prototype.insertBefore,
        $ = V.prototype.removeChild,
        X = V.prototype.replaceChild,
      ...
      (_.prototype = Object.create(S.prototype)),
        D(_.prototype, {
          ...
          insertBefore: function(e, n) {
            ...
            if (((o = c ? a(e) : i(e, this, s, n)), c)) h(this, e), w(this), Y.call(I(this), P(e), r);
            else {
              s || (this.firstChild_ = o[0]),
                n ||
                  ((this.lastChild_ = o[o.length - 1]),
                  void 0 === this.firstChild_ && (this.firstChild_ = this.firstChild));
              var l = r ? r.parentNode : I(this);
              l ? Y.call(l, m(this, o), r) : f(this, o);
            }
          ...
          replaceChild: function(e, r) {
            ...
            return (
              p ? (s = a(e)) : (c === e && (c = e.nextSibling), (s = i(e, this, l, c))),
              p
                ? (h(this, e), w(this), X.call(I(this), P(e), o))
                : (this.firstChild === r && (this.firstChild_ = s[0]),
                  ...
                  o.parentNode && X.call(o.parentNode, m(this, s), o)),
              N(this, 'childList', { addedNodes: s, removedNodes: n(r), nextSibling: c, previousSibling: l }),
              d(r),
              u(s, this),
              r
            );
        ...
        (e.originalInsertBefore = Y),
        (e.originalRemoveChild = $),
    ...
    (function(e) {
      ...
      function r(e) {
        return String(e)
          ...
          .replace(/([^\s]):host/g, '$1')
          .replace(':host', '*')
          .replace(/\^|\/shadow\/|\/shadow-deep\/|::shadow|\/deep\/|::content|>>>/g, ' ');
      }
      function o(e, t) {
    ...
    (function(e) {
      ...
      (r.prototype = Object.create(a.prototype)),
        ...
        m.prototype.webkitCreateShadowRoot && (r.prototype.webkitCreateShadowRoot = r.prototype.createShadowRoot),
        d(r.prototype, o),
        d(r.prototype, i),
        d(r.prototype, s),
        d(r.prototype, c),
    ...
    (function(e) {
      ...
      (l.prototype = Object.create(m.prototype)),
        ...
        ['getBoundingClientRect', 'getClientRects', 'scrollIntoView'].forEach(f),
        ...
        r(t.prototype, {
          ...
          setAttribute: function(e, t) {
            n.prototype.setAttribute.call(this, e, t),
              'select' === String(e).toLowerCase() && this.invalidateShadowRenderer(!0);
          }
        }),
        i && o(i, t),
    ...
    (function(e) {
      'use strict';
      var t = e.wrappers.Element,
        n = e.wrappers.HTMLElement,
        r = e.registerObject,
        o = e.defineWrapGetter,
        i = 'http://www.w3.org/2000/svg',
        a = document.createElementNS(i, 'title'),
        s = r(a),
        c = Object.getPrototypeOf(s.prototype).constructor;
      if (!('classList' in a)) {
    ...
    (function(e) {
      'use strict';
      var t = e.GetElementsByInterface,
        n = e.NonElementParentNodeInterface,
        r = e.ParentNodeInterface,
        o = e.SelectorsInterface,
        i = e.mixin,
        a = e.registerObject,
        s = a(document.createDocumentFragment());
      i(s.prototype, r), i(s.prototype, o), i(s.prototype, t), i(s.prototype, n);
      var c = a(document.createComment(''));
      (e.wrappers.Comment = c), (e.wrappers.DocumentFragment = s);
    })(window.ShadowDOMPolyfill),
    (function(e) {
      'use strict';
      function t(e) {
    ...
    (function(e) {
      ...
      y(
        ...
        y([window.HTMLBodyElement, window.HTMLHeadElement, window.HTMLHtmlElement], E),
        y(
          [window.HTMLDocument || window.Document],
          [
            'adoptNode',
        ...
        S(window.Document, t, document.implementation.createHTMLDocument('')),
        window.HTMLDocument && S(window.HTMLDocument, t),
        j([window.HTMLBodyElement, window.HTMLDocument || window.Document, window.HTMLHeadElement]);
      ...
      (a.prototype.createDocument = function() {
        ...
        c(a, 'hasFeature'),
        S(window.DOMImplementation, a),
        y([window.DOMImplementation], ['createDocument', 'createDocumentType', 'createHTMLDocument', 'hasFeature']),
      ...
      var u = {
              ...
              o.forEach(function(e) {
                (e = e.trim()),
                  this.selectorNeedsScoping(e, t) &&
                    (e = n && !e.match(O) ? this.applyStrictSelectorScope(e, t) : this.applySelectorScope(e, t)),
                  r.push(e);
              }, this),
              r.join(', ')
            );
          ...
          propertiesFromRule: function(e) {
            ...
            e.style.content &&
              ...
              (t = t.replace(/content:[^;]*;/g, "content: '" + e.style.content + "';"));
            var n = e.style;
          ...
          document.addEventListener('DOMContentLoaded', function() {
            ...
            if (window.HTMLImports && !HTMLImports.useNative) {
              ...
              HTMLImports.parser.parseGeneric = function(e) {
                if (!e[x]) {
                  ...
                  e.__resource && ((t = e.ownerDocument.createElement('style')), (t.textContent = e.__resource)),
                    ...
                    t.setAttribute(x, ''),
                    (t[x] = !0),
                    t.parentNode !== P && (e.parentNode === P ? P.replaceChild(t, e) : this.addElementToDocument(t)),
                    (t.__importParsed = !0),
              ...
              HTMLImports.parser.hasResource = function(e) {
                return 'link' === e.localName && 'stylesheet' === e.rel && e.hasAttribute(H)
                  ? e.__resource
                  : o.call(this, e);
              };
            }
  ...
  (function(e) {
    window.ShadowDOMPolyfill
      ? ((window.wrap = ShadowDOMPolyfill.wrapIfNeeded), (window.unwrap = ShadowDOMPolyfill.unwrapIfNeeded))
            ...
            if (f == y || '/' == y || '\\' == y || '?' == y || '#' == y) {
              2 != d.length || !m.test(d[0]) || (':' != d[1] && '|' != d[1])
                ? 0 == d.length
                  ...
                  : ((this._host = r.call(this, d)), (d = ''), (l = 'relative path start'))
                : (l = 'relative path');
              continue;
            }
          ...
          case 'relative path':
            if (f != y && '/' != y && '\\' != y && (a || ('?' != y && '#' != y)))
              ...
              (L = h[d.toLowerCase()]) && (d = L),
                '..' == d
                  ? (this._path.pop(), '/' != y && '\\' != y && this._path.push(''))
                  : '.' == d && '/' != y && '\\' != y
                  ? this._path.push('')
                  : '.' != d &&
                    ('file' == this._scheme &&
  ...
  (function(e) {
    ...
    (f.prototype = {
      ...
      e.MutationObserver || (e.MutationObserver = a);
  })(this),
  ...
  (function(e) {
    ...
    function i(e, t) {
      ...
      if (l)
        for (var p, h = 0; l > h && (p = s[h]); h++)
          a(p) ? (c++, n()) : (p.addEventListener('load', r), p.addEventListener('error', i));
      else n();
    }
    function a(e) {
    ...
    var w = /Trident|Edge/.test(navigator.userAgent),
    ...
    var a = e.path,
      ...
      p = {
        ...
        parseImport: function(e) {
          if (
            (HTMLImports.__importsParsingHook && HTMLImports.__importsParsingHook(e),
            e['import'] && (e['import'].__importParsed = !0),
            this.markParsingComplete(e),
            e.dispatchEvent(
              e.__resource && !e.__error
                ? new CustomEvent('load', { bubbles: !1 })
                : new CustomEvent('error', { bubbles: !1 })
            ),
            e.__pending)
          )
        ...
        nextToParseInDoc: function(e, n) {
          if (e && this._mayParse.indexOf(e) < 0) {
            ...
            for (
              var r, o = e.querySelectorAll(this.parseSelectorsForNode(e)), i = 0, a = o.length;
              a > i && (r = o[i]);
              i++
            )
              if (!this.isParsed(r))
  ...
  (function(e) {
    ...
    (e.addModule = r),
      ...
      (e.useNative =
        !t.register && e.hasNative && !window.ShadowDOMPolyfill && (!window.HTMLImports || HTMLImports.useNative));
  ...
  window.CustomElements.addModule(function(e) {
    ...
    function v(e) {
      (e = wrap(e)),
        b.dom && console.group('upgradeDocument: ', e.baseURI.split('/').pop()),
        t(e),
        w(e),
        b.dom && console.groupEnd();
    }
    ...
    var b = e.flags,
      y = e.forSubtree,
      E = e.forDocumentTree,
      _ = !window.MutationObserver || window.MutationObserver === window.JsMutationObserver;
    ...
    function t(t) {
      if (!t.__upgraded__ && t.nodeType === Node.ELEMENT_NODE) {
        var r = t.getAttribute('is'),
          o = e.getRegisteredDefinition(r || t.localName);
        if (o) {
  ...
  (function(e) {
    function t() {
      a(wrap(document)),
        window.HTMLImports &&
          (HTMLImports.__importsParsingHook = function(e) {
            a(wrap(e['import']));
          }),
  ...
  (function(e) {
    ...
    (window.Polymer = o),
      (e.consumeDeclarations = function(t) {
